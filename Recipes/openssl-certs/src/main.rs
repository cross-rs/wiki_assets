//! A program that generates ca certs, certs verified by
//! the ca, and public and private keys.
//!
//! This file was taken from Rust OpenSSL, and is licensed under the
//! Apache2.0 license. The repository for the code is found [here][openssl].
//! See `LICENSE-OPENSSL` for license terms.
//!
//! [openssl]: https://raw.githubusercontent.com/sfackler/rust-openssl
